...
void load_sprites()
{
    SpritePlayerId     = PSE_Context->load_image("src/pse-modules/rogue/textures/player.png");
    SpriteEnemyId      = PSE_Context->load_image("src/pse-modules/rogue/textures/enemy.png");
    SpriteFloorLightId = PSE_Context->load_image("src/pse-modules/rogue/textures/floor_light.png");
    SpriteFloorDarkId  = PSE_Context->load_image("src/pse-modules/rogue/textures/floor_dark.png");
    SpriteWallId       = PSE_Context->load_image("src/pse-modules/rogue/textures/wall.png");
    SpriteStairUpId    = PSE_Context->load_image("src/pse-modules/rogue/textures/stair_up.png");
    SpriteStairDownId  = PSE_Context->load_image("src/pse-modules/rogue/textures/stair_down.png");
}
